			<aside class="col-md-4 blog-sidebar">
              ...
              <div class="p-4">
                <h4 class="font-italic">Kategori Video</h4>
                <ol class="list-unstyled mb-0">
                  <li><a class="badge badge-primary" href="#">Politik</a></li>
                  <li><a class="badge badge-primary" href="#">Religi</a></li>
                  <li><a class="badge badge-primary" href="#">Pendidikan</a></li>
                  <li><a class="badge badge-primary" href="#">Teknologi</a></li>
                  <li><a class="badge badge-primary" href="#">Seni</a></li>
                  <li><a class="badge badge-primary" href="#">Kegiatan</a></li>
                  <li><a class="badge badge-primary" href="#">Viral</a></li>
                </ol>
              </div>
