		      	...
		      	<div class="row">
		      		...
		      		<div class="col-sm-6">
		      			<div class="container-fluid">
		      				...
		      				<a href="#" target="_blank" class="btn btn-success"><i class="fa fa-users"></i> Gabung ke group WhatsApp</a><br/>
	      					...
	      					<!-- <form id="regis_event" method="post"> -->
	                            ...
	                            ?>
					      		...
					      		<h4>Grand Prize 1 Unit Motor Yamaha NMAX<br/>Di Undi pada akhir tahun 2022</h4>
					      		</div>
					      	<!-- </form> -->
				      		<hr style="background-color: #fff;"></hr>
