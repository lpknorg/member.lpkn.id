                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    ...
                                    <div class="row" style="margin-bottom: 10px">
                                        <div class="col-md-4">
                                            <h4 style="margin-top:0px">Tbl Menu List</h4>
                                        </div>
                                        ...
                                        <script type="text/javascript">
                                            $(document).ready(function() {
                                                ...
                                                var t = $("#mytable").dataTable({
                                                    ...
                                                    processing: true,
                                                    serverSide: true,
                                                    ajax: {"url": "tbl_menu/json", "type": "POST", "data": {'<?php echo $this->security->get_csrf_token_name(); ?>' : '<?php echo $this->security->get_csrf_hash(); ?>'} },
                                                    columns: [
                                                        {
                                                            "data": "id",
                                                            "orderable": false
                                                        },{"data": "label"},{"data": "icon"},{"data": "type"},{"data": "link"},{"data": "parent"},{"data": "sort"},
                                                        {
                                                            "data" : "all",
                                                            "orderable": false,
