                                    ...
                                    <div class="card-body">
                                        ...
                                        <table class="table">
	                                        ...
	                                        <tr>
                                                ...
                                                <td>
                                                  <?php if($status == 0){ ?>
                                                    <button type="button" class="btn btn-warning" onclick="if(confirm('Are you sure?')) load_controler('pembayaran/konfirmasi_manual/<?=$id?>');"><i class="fa fa-check"></i> Konfirmasi Pembayaran</button>
                                                    <!-- <a class="btn btn-success" target="_blank" href="https://app.midtrans.com/snap/v2/vtweb/<?=$snaptoken?>"><i class="fa fa-check"></i> Konfirmasi Pembayaran</a> -->
