                    ...
                    <div class="animated fadeIn">
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 style="margin-top:0px">Mata Kuliah Detail</h4><br>
                                        <table class="table">
	                                        ...
	                                        <tr><td></td><td><button type="button" class="btn btn-default" onclick="load_controler('mata_kuliah');">Cancel</button></td></tr>
	                                    </table>
                                    </div>
                                </div>
                            </div>
