                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    ...
                                    <div class="row" style="margin-bottom: 10px">
                                        <div class="col-md-4">
                                            <h4 style="margin-top:0px">Majalah List</h4>
                                        </div>
                                        ...
                                        <?php if($this->ion_auth_acl->has_permission('access_admin') OR $this->ion_auth_acl->has_permission('create_majalah')) : ?>
                                            <button class="btn btn-primary btn-sm" onclick="load_controler('majalah/create');">Create</button>
                                        <?php endif; ?>
	                                      </div>
                                            </div>
                                                ...
                                                var t = $("#mytable").dataTable({
                                                    ...
                                                    columns: [
                                                        {
                                                            "data": "id",
                                                            "orderable": false
                                                        },{"data": "judul"},{"data": "foto"},{"data": "file"},{"data": "ket"},{"data": "create_date"},
                                                        {
                                                            "data" : "all",
                                                            "orderable": false,
                                                    ...
                                                    rowCallback: function(row, data, iDisplayIndex) {
                                                        ...
                                                        if( data['foto'] == 'gagal' ) {
                                                            ...
                                                            $('td', row).eq(3).html('<a href="<?=base_url()?>majalah/download/'+data['id']+'" target=_blank">Download File</a>')
                                                        }
                                                    }
                                                });
                                            });
