...
$config['message_start_delimiter'] = '<div class="alert alert-success alert-dismissible fade show" role="alert">'; 	// Message start delimiter
$config['message_end_delimiter']   = '<button class="close" type="button" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">×</span></button></div>'; 	// Message end delimiter
$config['error_start_delimiter']   = '<div class="alert alert-danger alert-dismissible fade show" role="alert">';		// Error message start delimiter
$config['error_end_delimiter']     = '<button class="close" type="button" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">×</span></button></div>';	// Error message end delimiter
